...
const Profile = () => {
  ...
  const handleSaveProfile = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:3000/user/userProfile/update/${userId}`, {
        method: "PUT",
        headers: {
  ...
  const handleStarRepo = async (repoId) => {
    try {
      ...
      const response = await fetch(`http://localhost:3000/repo/star/${repoId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleUnstarRepo = async (repoId) => {
    try {
      ...
      const response = await fetch(`http://localhost:3000/repo/unstar/${repoId}`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
